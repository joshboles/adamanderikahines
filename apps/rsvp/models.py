...
class Rsvp(TimeStampedModel):
    ...
    stuffed_turkey_roulade = models.IntegerField(default=0, help_text="Sliced turkey breast stuffed with pine nuts, carrots, spinach & red onions. Served with an orange and terragon burgundy sauce. (The Bride and Grooms favorite)")
